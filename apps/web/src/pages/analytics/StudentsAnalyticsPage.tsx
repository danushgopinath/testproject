    ...
    <div className="flex w-full">
        ...
        <div className="rounded-xl border border-border bg-surface p-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="mt-2 text-2xl font-bold text-text-primary">{stats.totalStudents}</p>
            </div>
        ...
        <div className="rounded-xl border border-border bg-surface p-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="mt-2 text-2xl font-bold text-text-primary">{stats.activeStudents}</p>
            </div>
      ...
      <div className="mt-8 rounded-xl border border-border bg-surface p-6">
        ...
        <p className="text-sm text-text-muted">
          Detailed student analytics and engagement metrics will be available here soon.
        </p>
      </div>
        </div>
      </div>
